...
// Generated on 2025-11-07T15:20:52.252668
...
class CKRecordBuilder {
  ...
  /// Creates a stairSpeed record.
  ///
  /// [speedSamples] The speedSamples samples.
  /// [startTime] The start time of the stairSpeed.
  /// [endTime] The end time of the stairSpeed.
  /// [startZoneOffset] Optional timezone offset at start time.
  /// [endZoneOffset] Optional timezone offset at end time.
  /// [source] The source of the stairSpeed data.
  ///
  /// Returns a [CKDataRecord] representing the stairSpeed.
  static CKDataRecord stairSpeed({
    required List<CKSample> speedSamples,
    required CKVelocityUnit speedSamplesUnit,
    required DateTime startTime,
    required DateTime endTime,
  ...
  /// Creates a sixMinuteWalkDistance record.
  ///
  /// [length] The length value.
  /// [startTime] The start time of the sixMinuteWalkDistance.
  /// [endTime] The end time of the sixMinuteWalkDistance.
  /// [startZoneOffset] Optional timezone offset at start time.
  /// [endZoneOffset] Optional timezone offset at end time.
  /// [source] The source of the sixMinuteWalkDistance data.
  ///
  /// Returns a [CKDataRecord] representing the sixMinuteWalkDistance.
  static CKDataRecord sixMinuteWalkDistance({
    required num length,
    required CKLengthUnit lengthUnit,
    required DateTime startTime,
    required DateTime endTime,
    ...
    return CKDataRecord(
      type: CKType.sixMinuteWalkDistance,
      data: CKQuantityValue(length, lengthUnit),
      startTime: startTime,
      endTime: endTime,
      startZoneOffset: startZoneOffset,
  ...
  ///
  /// [notes] The notes label.
  /// [time] The time of the lactation.
  /// [zoneOffset] Optional timezone offset at the time.
  /// [source] The source of the lactation data.
  ///
  /// Returns a [CKDataRecord] representing the lactation.
  static CKDataRecord lactation({
    String? notes,
    required DateTime time,
    Duration? zoneOffset,
    required CKSource source,
  ...
  ///
  /// [notes] The notes label.
  /// [time] The time of the pregnancy.
  /// [zoneOffset] Optional timezone offset at the time.
  /// [source] The source of the pregnancy data.
  ///
  /// Returns a [CKDataRecord] representing the pregnancy.
  static CKDataRecord pregnancy({
    String? notes,
    required DateTime time,
    Duration? zoneOffset,
    required CKSource source,
  ...
  ///
  /// [mindfulnessSessionType] The mindfulnessSessionType category.
  /// [notes] The notes label.
  ...
  static CKDataRecord mindfulSession({
    required CKMindfulnessSessionType mindfulnessSessionType,
    String? notes,
    String? title,
    required DateTime startTime,
    required DateTime endTime,
    ...
    final data = <String, CKValue>{
      'mindfulnessSessionType': CKCategoryValue(mindfulnessSessionType),
    };
  ...
  ///
  /// [notes] The notes label.
  /// [time] The time of the uvExposure.
  /// [zoneOffset] Optional timezone offset at the time.
  ...
  ///
  /// [notes] The notes label.
  /// [time] The time of the timeInDaylight.
  /// [zoneOffset] Optional timezone offset at the time.
